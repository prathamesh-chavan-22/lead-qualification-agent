/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d611f34987c3d4a6df833dab7ac6aa62)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "LeadAgent" | "OfficeCalendar";
	}
	interface Env {
		AI: Ai;
		LeadAgent: DurableObjectNamespace<import("./src/worker/index").LeadAgent>;
		OfficeCalendar: DurableObjectNamespace<import("./src/worker/index").OfficeCalendar>;
	}
}
